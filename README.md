...
> Note: `assets/` contains two static illustrative charts used only for this README preview. They are not produced by the notebook — the notebook itself outputs numeric results via an interactive CLI, not plots.
